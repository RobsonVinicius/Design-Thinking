...
Neste capitúlo, vimos:
* Que precisamos criar fluxos para entender como funcionam as interações
* Que temos de pensar no tipo de protótipo que precisamos criar.
* Uma ferramenta para prototipação.